...
window.addEventListener("DOMContentLoaded", function () {
  Object(_modules_modal__WEBPACK_IMPORTED_MODULE_1__["modal"])(".popup_engineer_btn", ".popup_engineer", ".popup_engineer .popup_close"); //(triggerSelector, modalSelector, closeSelector, clickOverlay)

  Object(_modules_modal__WEBPACK_IMPORTED_MODULE_1__["modal"])(".phone_link", ".popup", ".popup .popup_close");
  Object(_modules_modal__WEBPACK_IMPORTED_MODULE_1__["modal"])(".popup_calc_profile_button", ".popup", ".popup .popup_close", false);
  Object(_modules_modal__WEBPACK_IMPORTED_MODULE_1__["modal"])(".glazing_price_btn", ".popup_calc", ".popup_calc_close");
  Object(_modules_modal__WEBPACK_IMPORTED_MODULE_1__["modal"])(".popup_calc_button", ".popup_calc_profile", ".popup_calc_profile_close", false);
  Object(_modules_modal__WEBPACK_IMPORTED_MODULE_1__["modalTimeout"])(".popup", 60000); //(modalSelector, time)

  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_3__["default"])(".glazing_slider", ".glazing_block", ".glazing_content", "active"); //(headerSelector, tabSelector, contentSelector, activeClass)
  ...
  Object(_modules_form__WEBPACK_IMPORTED_MODULE_2__["default"])(".form", "http://localhost:3000/data", "user_phone"); //(formSelector, url, nameDigitalInput)

  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_3__["default"])(".balcon_icons", ".balcon_icons_img", ".big_img > img", "do_image_more", "inline"); //(headerSelector, tabSelector, contentSelector, activeClass, display = "block")

  Object(_modules_calc__WEBPACK_IMPORTED_MODULE_4__["default"])("[data-input-balcon]", ".popup_calc_button", "http://localhost:3000/balcon"); //(inputSelector, buttonSelector, url)
});
...
/* harmony import */ var _services_senddata__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../services/senddata */ "./src/services/senddata.js");
...
var calc = function calc(inputSelector, buttonSelector, url) {
  ...
  button.addEventListener('click', function () {
    ...
    Object(_services_senddata__WEBPACK_IMPORTED_MODULE_2__["default"])(json, url).then(function (response) {
...
/* harmony import */ var _services_senddata__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../services/senddata */ "./src/services/senddata.js");
...
var form = function form(formSelector, url, nameDigitalInput) {
  var forms = document.querySelectorAll(formSelector),
      phoneInputs = document.querySelectorAll("input[name=".concat(nameDigitalInput, "]"));
  ...
  forms.forEach(function (form, i) {
    form.addEventListener('submit', function (event) {
      ...
      Object(_services_senddata__WEBPACK_IMPORTED_MODULE_8__["default"])(json, url).then(function (response) {
        if (response.ok) {
          return response;
        } else {
...
/*!******************************!*\
  !*** ./src/modules/modal.js ***!
  \******************************/
/*! exports provided: modal, modalTimeout */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "modal", function() { return modal; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "modalTimeout", function() { return modalTimeout; });
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each */ "./node_modules/core-js/modules/web.dom-collections.for-each.js");
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0__);

var modalTime;

var modal = function modal(triggerSelector, modalSelector, closeSelector) {
  var clickOverlay = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : true;
  ...
  trigger.forEach(function (item, i) {
    item.addEventListener('click', function (event) {
      ...
      otherModal.forEach(function (item) {
        closeModal(item);
      });
...
var modalTimeout = function modalTimeout(modalSelector, time) {
  var modalBlock = document.querySelector(modalSelector);
  modalTime = setTimeout(function () {
    openModal(modalBlock);
  }, time);
};
...
var sendData = function sendData(data, url) {
  var response;
...
/* harmony default export */ __webpack_exports__["default"] = (sendData);
